...
`;const st=function(){const e=[];return{register:t=>{e.push(t)},createHandler:t=>n=>{for(const r of e){const e=r(t,n);if(0!==e.length)return e}return[]}}}(),dt=g.exports.createContext({}),ut=dt.Provider;function pt(){return g.exports.useContext(dt)}const mt=({element:e,render:t})=>B()?null:d.createElement(ft,{element:e,render:t}),ft=({element:e,render:t})=>{const n=be(),r=T(),o=n.selection&&m.isCollapsed(n.selection),i=r&&o,[a,c]=g.exports.useState(!1),l={element:e,meta:{empty:p.isEmpty(n,e)},active:a,setActive:c},s=z({controls:!0,visible:a||i});return d.createElement(ut,{value:l},d.createElement("div",{className:s,contentEditable:!1},t()))},ht={paragraph:F,"heading-1":I,"heading-2":{type:"heading-2",name:"Heading-2",code:"h2",aliases:["heading-2","title"],allowedModifications:[],allowedTransformations:["heading-1","heading-3","paragraph"],create:(e=[{text:""}])=>({type:"heading-2",children:e})},"heading-3":{type:"heading-3",name:"Heading-3",code:"h3",aliases:["heading-3","title"],allowedModifications:[],allowedTransformations:["heading-1","heading-2","paragraph"],create:(e=[{text:""}])=>({type:"heading-3",children:e})},"ordered-list":G,"unordered-list":U,"list-item":Z,code:_,"code-line":Q},gt=({svg:e,iconClassName:t,content:n,sections:r})=>{const{active:o,setActive:i}=pt(),[a,c]=g.exports.useState(!1),l=()=>c(!1),s=z({"block-menu-icon":!0,[t]:!0,active:a});return d.createElement(S,{theme:Ee,interactive:!0,placement:"bottom-end",content:d.createElement(bt,{active:o},d.createElement(n,{show:()=>c(!0),hide:l,sections:r})),visible:a,onShow:()=>i(!0),onHidden:()=>i(!1),onClickOutside:l},d.createElement("div",{className:s,onClick:()=>c((e=>!e))},d.createElement(e,null)))},bt=({active:e,children:t})=>e?t:null,yt=({children:e})=>d.createElement("div",{className:"block-menu-container"},e),xt=({name:e,children:t})=>d.createElement("div",{className:"block-menu-section"},d.createElement("p",{className:"block-menu-list-name"},e),t),vt=e=>{var t=e,{children:n}=t,r=s(t,["children"]);return d.createElement("ul",c({className:"block-menu-list"},r),n)},kt=e=>{var t=e,{name:n,detail:r,onClick:o}=t,i=s(t,["name","detail","onClick"]);return d.createElement("li",c({className:"block-menu-item",onClick:o},i),d.createElement("span",{className:"block-menu-item-name"},n),r&&d.createElement("span",{className:"block-menu-item-detail"},r))},wt=e=>d.createElement(gt,c({svg:Et,iconClassName:"plus",content:Ct},e)),Et=e=>d.createElement("svg",c({preserveAspectRatio:"xMidYMid meet",height:"1em",width:"1em",fill:"none",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",stroke:"currentColor"},e),d.createElement("g",null,d.createElement("line",{x1:"12",y1:"5",x2:"12",y2:"19"}),d.createElement("line",{x1:"5",y1:"12",x2:"19",y2:"12"}))),Ct=({hide:e})=>{const t=be(),n=ye(),{element:r}=pt(),o=function(e){const t=be();return k.findPath(t,e)}(r),i=g.exports.useMemo((()=>Object.values(ht).filter((e=>!1!==e.canBeAdded)).map((({type:r,name:i,code:a})=>d.createElement(kt,{key:r,name:i,detail:`/${a}`,onClick:()=>(r=>{var i;const a=ht[r];u.removeNodes(t,{at:o}),u.insertNodes(t,a.create(),{at:o,select:!0}),e(),null==(i=n.current)||i.focus()})(r)})))),[]);return d.createElement("div",{className:"block-menu"},d.createElement(xt,{name:"Select item type"},d.createElement(vt,null,i)))};const Nt=e=>d.createElement(gt,c({svg:Mt,iconClassName:"arrow",content:Lt},e)),Mt=e=>d.createElement("svg",c({preserveAspectRatio:"xMidYMid meet",height:"1em",width:"1em",fill:"none",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",stroke:"currentColor"},e),d.createElement("g",null,d.createElement("polyline",{points:"6 9 12 15 18 9"}))),Lt=e=>{const{sections:t=[]}=e;return d.createElement("div",{className:"block-menu"},d.createElement(At,c({},e)),t.map(((t,n)=>{const r=t;return d.createElement(r,c({key:n},e))})))},At=({hide:e})=>{const t=be(),n=ye(),{element:r}=pt(),o=function(e){const t=be();return k.findPath(t,e)}(r),i=ht[r.type],a=g.exports.useMemo((()=>i.allowedTransformations.map((r=>{const{name:i,code:a}=ht[r];return d.createElement(kt,{key:r,name:i,detail:`/${a}`,onClick:()=>(r=>{var i;u.setNodes(t,{type:r},{at:o}),e(),null==(i=n.current)||i.focus()})(r)})}))),[i]);return 0===a.length?null:d.createElement(xt,{name:"Select item type"},d.createElement(vt,null,a))};const St=e=>{const{meta:t}=pt(),n=t.empty?wt:Nt;return d.createElement(n,c({},e))},Bt=" ".repeat(2);const Tt={insertExitBreak:function(e){const t={handled:!0};if(!e.selection)return t;m.isExpanded(e.selection)&&u.delete(e);const n=se.getAbove(e,{type:"block",match:le.block(e,"code-line")});if(!n)return{handled:!1};const[r,o]=n;let i=0;const a=p.string(e,o);for(const l of a){if(" "!==l)break;i+=1}const c=a[p.start(e,e.selection).offset-1];if("{"===c&&(i+=2),"("===c&&(i+=2),"<"===c&&(i+=2),":"===c&&(i+=2),u.splitNodes(e,{match:le.equals(e,r),always:!0}),u.select(e,h.next(o)),u.collapse(e,{edge:"start"}),i>0){const t=p.start(e,h.next(o));u.insertText(e," ".repeat(i),{at:t})}return t},indent:function(e){const t=p.nodes(e,{match:le.block(e,"code-line")});for(const[,n]of t){const t=p.start(e,n);u.insertText(e,Bt,{at:t})}},outdent:function(e){const t=p.nodes(e,{match:le.block(e,"code-line")});for(const[,n]of t){const t=p.start(e,n),[r]=p.node(e,t),o=D.string(r);let i=t.offset,a=0;for(const e of o){if(" "!==e)break;if(i+=1,a+=1,2===a)break}if(0===a)continue;const c={path:t.path,offset:i},l=p.range(e,t,c);u.delete(e,{at:l})}}};function zt({editor:e}){return se.isInBlock(e,"code")}Qe.override("insert-exit-break",(({editor:e,event:t})=>{t.preventDefault(),Tt.insertExitBreak(e)}),{match:zt}),Qe.override("insert-soft-break",(({editor:e,event:t})=>{t.preventDefault(),Tt.insertExitBreak(e)}),{match:zt}),Qe.override("copy-all",(({editor:e,event:t})=>{const n=se.getAbove(e,{type:"block",match:le.block(e,"code")});if(!n)return{skipped:!0};const[,r]=n;t.preventDefault(),u.select(e,r)}),{match:zt}),Qe.override("indent",(({event:e,editor:t})=>{e.preventDefault(),Tt.indent(t)}),{match:zt}),Qe.override("outdent",(({event:e,editor:t})=>{e.preventDefault(),Tt.outdent(t)}),{match:zt}),Qe.override("exit-block",(({editor:e,event:t})=>{const n=se.getAbove(e,{type:"block",match:le.block(e,"code")});if(!n)return{skipped:!0};const[,r]=n;t.preventDefault(),u.insertNodes(e,V(),{at:h.next(r),select:!0})}),{match:zt});st.register(((e,t)=>{const[n,r]=t;if(!le.block(e,"code-line")(n))return[];const o=se.getAbove(e,{at:r,type:"block",match:le.block(e,"code")});if(!o)return[];const[i]=o,a=[],c=D.string(n),l=O.tokenize(c,O.languages[i.language]);let s=0;for(const d of l)"string"!=typeof d?(a.push({anchor:{path:r,offset:s},focus:{path:r,offset:s+d.length},prismToken:d.type}),s+=d.length):s+=d.length;return a}));const Dt=[{grammarName:"plain",name:"Plain Text"},{grammarName:"javascript",name:"JavaScript"},{grammarName:"typescript",name:"TypeScript"},{grammarName:"jsx",name:"React JSX"},{grammarName:"tsx",name:"React TSX"},{grammarName:"rust",name:"Rust"},{grammarName:"xml",name:"HTML"},{grammarName:"json",name:"JSON"},{grammarName:"bash",name:"Bash"},{grammarName:"csharp",name:"C#"},{grammarName:"css",name:"CSS"},{grammarName:"cmake",name:"CMake"},{grammarName:"docker",name:"Docker"},{grammarName:"graphql",name:"GraphQL"},{grammarName:"xml",name:"XML"},{grammarName:"makefile",name:"Makefile"},{grammarName:"sql",name:"SQL"},{grammarName:"xml",name:"SVG"},{grammarName:"yaml",name:"YAML"},{grammarName:"python",name:"Python"}],Ot=e=>{const{element:t}=pt();return"code"!==t.type?null:d.createElement(Rt,c({},e))},Rt=({hide:e})=>{const t=be(),{element:n}=pt(),r=function(e){const t=be();return k.findPath(t,e)}(n),o=g.exports.useRef(null),[i,a]=g.exports.useState(""),c=g.exports.useMemo((()=>Dt.filter((e=>e.name.toLowerCase().includes(i.toLowerCase())))),[i]);return g.exports.useEffect((()=>{o.current&&o.current.focus()}),[]),"code"!==n.type?null:d.createElement(xt,{name:"Select code language"},d.createElement(yt,null,d.createElement(Pt,null,d.createElement(It,null,Ht),d.createElement(jt,{ref:o,value:i,onChange:e=>a(e.target.value)}))),d.createElement(vt,{style:{maxHeight:200,overflow:"auto"}},c.map((o=>{const i=o.grammarName===n.language;return d.createElement(kt,{key:o.name,name:o.name,onClick:()=>(n=>{u.setNodes(t,{language:n},{at:r}),e()})(o.grammarName),style:{color:i?"rgb(56, 132, 255)":""}})}))))},Pt=L.div`
  display: flex;
  flex-direction: row;
  align-items: center;
...
`,_t=()=>d.createElement(d.Fragment,null,d.createElement(Xt,null));function Vt(e){return le.block(e,["ordered-list","unordered-list"])}function en(e,t){return([n,r])=>{const[o,i]=se.isOnEdges(e,{of:r}),a=p.isEmpty(e,n),c=t.node.children;return{isFirst:c[0]===n,isLast:c[c.length-1]===n,isOnStart:o,isOnEnd:i,isEmpty:a,isList:Vt(e)(n)}}}function tn(e){return le.block(e,"paragraph")}function nn(e,t,n){const{first:r,second:o,third:i}=n;return([n])=>{const a=t.node.children.findIndex((e=>e===n));return{isSimple:!(!r||"paragraph"!==r.node.type||o&&(!Vt(e)(o.node)||i)),index:a,isFirst:0===a,isLast:a===t.node.children.length-1,isEmpty:1===n.children.length&&tn(e)(n.children[0])&&p.isEmpty(e,n.children[0]),hasList:Vt(e)(n.children[1])}}}function rn({editor:e,entry:t,list:n}){if(!t)return{item:null,blocks:null};const r=function(e,t){const n=[t.node,t.path];return{first:an({entry:on(n,0),createMeta:en(e,t)}),second:an({entry:on(n,1),createMeta:en(e,t)}),third:an({entry:on(n,2),createMeta:en(e,t)})}}(e,function(e){const[t,n]=e;return{node:t,path:n}}(t)),o=an({entry:t,createMeta:nn(e,n,r)});return o?{item:o,blocks:r}:{item:null,blocks:null}}function on([e,t],n){if(e.children[n])return[e.children[n],t.concat(n)]}function an({entry:e,createMeta:t=(()=>({}))}){if(!e)return null;const[n,r]=e;return{node:n,path:r,meta:t([n,r])}}O.languages.plain={};const cn={info:function(e,t={}){const{at:n=e.selection}=t;if(!n)return;const r=se.getAbove(e,{at:n,type:"block",mode:"lowest",match:Vt(e)});if(!r)return;const o=se.getAbove(e,{at:n,type:"block",mode:"lowest",match:le.builder(e).block(["ordered-list","unordered-list"]).notEquals(r[0]).compile()}),i=an({entry:r,createMeta:()=>({isNested:Boolean(o)})});if(!i)return;const a=an({entry:o,createMeta:()=>({})}),{item:s,blocks:d}=rn({editor:e,entry:se.getAbove(e,{at:n,type:"block",mode:"lowest",match:le.block(e,"list-item")}),list:i});if(!s)return;if(!d)return;const u=an({entry:se.getAbove(e,{at:n,type:"block",mode:"lowest",match:le.builder(e).block("list-item").notEquals(s.node).compile()}),createMeta:()=>({})}),m=an({entry:se.getAbove(e,{at:n,type:"block",mode:"highest",match:le.childOf(e,s.node)}),createMeta:en(e,s)});if(!m)return;const f=le.builder(e).block("list-item").childOf(i.node).compile(),{item:h}=rn({editor:e,entry:p.previous(e,{at:s.path,match:f}),list:i}),{item:g}=rn({editor:e,entry:p.next(e,{at:s.path,match:f}),list:i}),b=le.builder(e).block().childOf(s.node).compile(),y=an({entry:p.previous(e,{at:m.path,match:b}),createMeta:en(e,s)}),x=an({entry:p.next(e,{at:m.path,match:b}),createMeta:en(e,s)});return{lists:{current:i,above:a},items:{current:s,previous:h,next:g,above:u},blocks:l(c({},d),{current:m,previous:y,next:x})}}};function ln(e,t,n={}){const{at:r=[]}=n,o=p.nodes(e,{at:r,match:n=>!!p.isBlock(e,n)&&n.type===t,reverse:!0}),i=Array.from(o).sort(((e,t)=>e[1].length-t[1].length));let a=null;const c=(e,t)=>{const n=h.next(e);return h.equals(n,t)};for(const l of i){if(!a){a=l;continue}const[,t]=l,[,n]=a;a=l,c(t,n)&&u.mergeNodes(e,{at:n})}}function sn(e,t={}){ln(e,"ordered-list",t),ln(e,"unordered-list",t)}function dn(e,{parent:t,match:n=(()=>!0),to:r,transform:o=(e=>e),willRemoveParent:i=(e=>e===t.node.children.length)}){const a=p.pathRef(e,r),c=new Map;for(const[d,u]of t.node.children.entries())c.set(u,d);const l=t.node.children.filter(n),s=i(l.length);if(l.length>0){const r=le.block(e);if(s?u.removeNodes(e,{at:t.path}):u.removeNodes(e,{at:t.path,match(e){if(!r(e))return!1;const t=c.get(e);return"number"==typeof t&&n(e,t)}}),!a.current)return;u.insertNodes(e,o(l),{at:a.current})}}function un(e,t={}){const{at:n=e.selection}=t;if(!n)return;if(m.isRange(n)&&m.isExpanded(n))return;const r=cn.info(e,{at:n});if(r){if(!r.lists.above||!r.items.above)return function(e,t={},n){const{at:r=e.selection}=t;if(!r)return;u.unwrapNodes(e,{at:n.items.current.path,mode:"all",split:!0,match:le.equals(e,[n.lists.current.node,n.items.current.node])}),sn(e)}(e,t,r);if(1!==r.lists.current.node.children.length){if(dn(e,{parent:r.lists.current,match:(e,t)=>t>r.items.current.meta.index,to:r.items.current.path.concat(r.items.current.node.children.length),transform:e=>W(r.lists.current.node.type,e)}),sn(e,{at:r.items.current.path}),r.items.current.meta.isFirst){const t=cn.info(e,{at:n});if(!t)return;if(!t.items.above)return;u.unwrapNodes(e,{at:t.items.current.path,mode:"all",split:!0,match:le.equals(e,[t.lists.current.node,t.items.above.node])})}else u.moveNodes(e,{at:r.items.current.path,to:h.next(r.items.above.path)});sn(e,{at:r.lists.above.path})}else u.unwrapNodes(e,{at:r.items.current.path,mode:"all",split:!0,match:function(e){var t;if(!r)return!1;const n=e===r.lists.current.node,o=e===(null==(t=r.items.above)?void 0:t.node);return n||o}})}}const pn={insertExitBreak:function(e){var t;const n={handled:!0},r={handled:!1};if(!e.selection)return n;m.isExpanded(e.selection)&&u.delete(e);const o=cn.info(e);return o?o.items.current.meta.isSimple?o.blocks.current.meta.isEmpty?(un(e),n):o.blocks.first?o.blocks.first.meta.isOnStart?((null==(t=o.items.previous)?void 0:t.meta.isEmpty)||u.insertNodes(e,q(),{at:o.items.current.path}),n):o.blocks.first.meta.isOnEnd?(o.blocks.second?u.insertNodes(e,q(),{at:o.blocks.second.path.concat(0),select:!0}):u.insertNodes(e,q(),{at:h.next(o.items.current.path),select:!0}),n):(u.splitNodes(e,{match:le.equals(e,o.items.current.node),always:!0}),n):n:r:n},deleteBackward:function(e){const t={handled:!1};if(!e.selection)return t;if(m.isExpanded(e.selection))return t;const n=se.getAbove(e,{type:"block",mode:"lowest",match:le.block(e,"list-item")});if(!n)return t;const[,r]=n,[o]=se.isOnEdges(e,{of:r});return o?(un(e),{handled:!0}):t},indent:function(e,t={}){const{at:n=e.selection}=t;if(!n)return;if(m.isRange(n)&&m.isExpanded(n))return;const r=cn.info(e,{at:n});if(!r)return;const{lists:o,items:i}=r;i.current.meta.isFirst||i.previous&&(u.wrapNodes(e,W(o.current.node.type,[]),{at:i.current.path}),u.moveNodes(e,{at:i.current.path,to:i.previous.path.concat(i.previous.node.children.length)}),sn(e,{at:i.previous.path}))},outdent:un,mergeSiblings:sn,moveChildren:dn};function mn({editor:e}){return se.isInBlock(e,["ordered-list","unordered-list"])}Qe.override("delete-backward",(({editor:e,event:t})=>{const{handled:n}=pn.deleteBackward(e);if(!n)return{skipped:!0};t.preventDefault()}),{match:mn}),Qe.override("insert-exit-break",(({editor:e,event:t})=>{const{handled:n}=pn.insertExitBreak(e);if(!n)return{skipped:!0};t.preventDefault()}),{match:mn}),Qe.override("indent",(({editor:e,event:t})=>{t.preventDefault(),pn.indent(e)}),{match:mn}),Qe.override("outdent",(({editor:e,event:t})=>{t.preventDefault(),pn.outdent(e)}),{match:mn});const fn={indent:function(e){if(!e.selection)return;if(m.isExpanded(e.selection))return;const t=se.getAbove(e,{type:"block",mode:"lowest",match:le.block(e,"paragraph")});if(!t)return;const[,n]=t;u.wrapNodes(e,q([]),{at:n});const r=(()=>{const t=p.previous(e,{at:n}),r=p.next(e,{at:n}),o=le.block(e,["ordered-list","unordered-list"]);if(t){const e=t[0];if(o(e))return e.type}if(r){const e=r[0];if(o(e))return e.type}return"unordered-list"})();u.wrapNodes(e,W(r,[]),{at:n}),pn.mergeSiblings(e)}};Qe.override("indent",(({editor:e,event:t})=>{t.preventDefault(),fn.indent(e)}),{match:function({editor:e}){return se.isInBlock(e,"paragraph")}});const hn=e=>{const t=function(e){const t=c({},e);return e.customKeybinds||(t.customKeybinds={}),e.customExtensions||(t.customExtensions=[]),t}(e),n=t.readOnly?d.createElement(Qt,c({},t)):d.createElement(Wt,c({},t));return d.createElement($e,{customExtensions:t.customExtensions},d.createElement(Ae,null),d.createElement(_t,null),d.createElement(ct,null),n)},gn=[{type:"heading-1",children:[{text:"Manage map or Set in effector store"}]},{type:"paragraph",children:[{text:"Sometimes we need to save Set in "},{text:"effector",italic:!0,href:"https://effector.dev"},{text:" store.\nSimple "},{text:"createStore(new Set())",inlineCode:!0},{text:" "},{text:"will not",bold:!0},{text:" trigger updates on "},{text:".add(item)",inlineCode:!0}]},{type:"unordered-list",children:[{type:"list-item",children:[{type:"paragraph",children:[{text:"a"}]},{type:"unordered-list",children:[{type:"list-item",children:[{type:"paragraph",children:[{text:"nested"}]}]}]}]},{type:"list-item",children:[{type:"paragraph",children:[{text:"b"}]},{type:"unordered-list",children:[{type:"list-item",children:[{type:"paragraph",children:[{text:"nested"}]}]}]}]},{type:"list-item",children:[{type:"paragraph",children:[{text:"c"}]},{type:"unordered-list",children:[{type:"list-item",children:[{type:"paragraph",children:[{text:"nested"}]}]}]}]}]},{type:"ordered-list",children:[{type:"list-item",children:[{type:"paragraph",children:[{text:"a"}]},{type:"ordered-list",children:[{type:"list-item",children:[{type:"paragraph",children:[{text:"nested"}]}]}]}]},{type:"list-item",children:[{type:"paragraph",children:[{text:"b"}]},{type:"ordered-list",children:[{type:"list-item",children:[{type:"paragraph",children:[{text:"nested"}]}]}]}]}]},{type:"code",children:[{type:"code-line",children:[{text:"const foo = 123;"}]},{type:"code-line",children:[{text:""}]},{type:"code-line",children:[{text:"const bar = 321;"}]}],language:"tsx"}];function bn(e,t=0,n=[]){for(const r of e)x.isText(r)||(n.push({name:r.type,offset:t}),bn(r.children,t+2,n));return n}function yn(e){const t=bn(e),n=[];for(const o of t){const e=" ".repeat(o.offset);n.push(e+o.name)}const r=n.join("\n");console.log(r)}const xn=()=>{const[e,t]=function(){const[e,t]=g.exports.useState(gn);return g.exports.useEffect((()=>yn(e)),[e]),[e,t]}();return d.createElement(hn,{value:e,onChange:t})};N.render(d.createElement(xn,null),document.querySelector("#root"));
