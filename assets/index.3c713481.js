...
`,Ke=e=>{var t=e,{icon:n,isActive:r,tooltip:o,style:i}=t,c=l(t,["icon","isActive","tooltip","style"]);const a=u.createElement(Fe,s({"data-active":r},c),u.createElement(Ie,{style:i},n));return o?u.createElement(B,{theme:fe,content:o,offset:[0,20],hideOnClick:!1},a):a};const Ze=({mark:e,icon:t,action:n,tooltip:r,style:o={}})=>{const i=ae(),c=function(e,t){const n=f.marks(e);return!!n&&Boolean(n[t])}(i,e),s=qe();return u.createElement(Ke,{icon:t,isActive:c,tooltip:r,onClick:e=>{e.preventDefault(),Pe.execute(n,{editor:i,event:ve,ui:s})},style:o})};const Ue=({editor:e,event:t})=>{if(!e.selection)return;if(p.isCollapsed(e.selection))return;const n=t.clipboardData.getData("text");new RegExp(xe).test(n)&&(t.preventDefault(),te.setHref(e,n))};function $e(){return{handlePaste:function(e,t=[]){return n=>{const r=s({event:n},e);for(const e of t){const t=e(r);if(t&&!t.continue)break}}}({editor:ae(),ui:qe()},[Ue])}}function We(e){return Q.block(e,["ordered-list","unordered-list"])}function _e(e,t){return([n,r])=>{const[o,i]=V.isOnEdges(e,{of:r}),c=f.isEmpty(e,n),s=t.node.children;return{isFirst:s[0]===n,isLast:s[s.length-1]===n,isOnStart:o,isOnEnd:i,isEmpty:c,isList:We(e)(n)}}}function Ge(e){return Q.block(e,"paragraph")}function Je(e,t,n){const{first:r,second:o,third:i}=n;return([n])=>{const c=t.node.children.findIndex((e=>e===n));return{isSimple:!(!r||"paragraph"!==r.node.type||o&&(!We(e)(o.node)||i)),index:c,isFirst:0===c,isLast:c===t.node.children.length-1,isEmpty:1===n.children.length&&Ge(e)(n.children[0])&&f.isEmpty(e,n.children[0]),hasList:We(e)(n.children[1])}}}function Qe({editor:e,entry:t,list:n}){if(!t)return{item:null,blocks:null};const r=function(e,t){const n=[t.node,t.path];return{first:Xe({entry:Ve(n,0),createMeta:_e(e,t)}),second:Xe({entry:Ve(n,1),createMeta:_e(e,t)}),third:Xe({entry:Ve(n,2),createMeta:_e(e,t)})}}(e,function(e){const[t,n]=e;return{node:t,path:n}}(t)),o=Xe({entry:t,createMeta:Je(e,n,r)});return o?{item:o,blocks:r}:{item:null,blocks:null}}function Ve([e,t],n){if(e.children[n])return[e.children[n],t.concat(n)]}function Xe({entry:e,createMeta:t=(()=>({}))}){if(!e)return null;const[n,r]=e;return{node:n,path:r,meta:t([n,r])}}const Ye={info:function(e,t={}){const{at:n=e.selection}=t;if(!n)return;const r=V.getAbove(e,{at:n,type:"block",mode:"lowest",match:We(e)});if(!r)return;const o=V.getAbove(e,{at:n,type:"block",mode:"lowest",match:Q.builder(e).block(["ordered-list","unordered-list"]).notEquals(r[0]).compile()}),i=Xe({entry:r,createMeta:()=>({isNested:Boolean(o)})});if(!i)return;const c=Xe({entry:o,createMeta:()=>({})}),{item:l,blocks:u}=Qe({editor:e,entry:V.getAbove(e,{at:n,type:"block",mode:"lowest",match:Q.block(e,"list-item")}),list:i});if(!l)return;if(!u)return;const d=Xe({entry:V.getAbove(e,{at:n,type:"block",mode:"lowest",match:Q.builder(e).block("list-item").notEquals(l.node).compile()}),createMeta:()=>({})}),p=Xe({entry:V.getAbove(e,{at:n,type:"block",mode:"highest",match:Q.childOf(e,l.node)}),createMeta:_e(e,l)});if(!p)return;const m=Q.builder(e).block("list-item").childOf(i.node).compile(),{item:h}=Qe({editor:e,entry:f.previous(e,{at:l.path,match:m}),list:i}),{item:g}=Qe({editor:e,entry:f.next(e,{at:l.path,match:m}),list:i}),y=Q.builder(e).block().childOf(l.node).compile(),b=Xe({entry:f.previous(e,{at:p.path,match:y}),createMeta:_e(e,l)}),x=Xe({entry:f.next(e,{at:p.path,match:y}),createMeta:_e(e,l)});return{lists:{current:i,above:c},items:{current:l,previous:h,next:g,above:d},blocks:a(s({},u),{current:p,previous:b,next:x})}}};function et(e,t,n={}){const{at:r=[]}=n,o=f.nodes(e,{at:r,match:n=>!!f.isBlock(e,n)&&n.type===t,reverse:!0}),i=Array.from(o).sort(((e,t)=>e[1].length-t[1].length));let c=null;const s=(e,t)=>{const n=h.next(e);return h.equals(n,t)};for(const a of i){if(!c){c=a;continue}const[,t]=a,[,n]=c;c=a,s(t,n)&&d.mergeNodes(e,{at:n})}}function tt(e,t={}){et(e,"ordered-list",t),et(e,"unordered-list",t)}function nt(e,{parent:t,match:n=(()=>!0),to:r,transform:o=(e=>e),willRemoveParent:i=(e=>e===t.node.children.length)}){const c=f.pathRef(e,r),s=new Map;for(const[u,d]of t.node.children.entries())s.set(d,u);const a=t.node.children.filter(n),l=i(a.length);if(a.length>0){const r=Q.block(e);if(l?d.removeNodes(e,{at:t.path}):d.removeNodes(e,{at:t.path,match(e){if(!r(e))return!1;const t=s.get(e);return"number"==typeof t&&n(e,t)}}),!c.current)return;d.insertNodes(e,o(a),{at:c.current})}}function rt(e,t={}){const{at:n=e.selection}=t;if(!n)return;if(p.isRange(n)&&p.isExpanded(n))return;const r=Ye.info(e,{at:n});if(r){if(!r.lists.above||!r.items.above)return function(e,t={},n){const{at:r=e.selection}=t;if(!r)return;d.unwrapNodes(e,{at:n.items.current.path,mode:"all",split:!0,match:Q.equals(e,[n.lists.current.node,n.items.current.node])}),tt(e)}(e,t,r);if(1!==r.lists.current.node.children.length){if(nt(e,{parent:r.lists.current,match:(e,t)=>t>r.items.current.meta.index,to:r.items.current.path.concat(r.items.current.node.children.length),transform:e=>q(r.lists.current.node.type,e)}),tt(e,{at:r.items.current.path}),r.items.current.meta.isFirst){const t=Ye.info(e,{at:n});if(!t)return;if(!t.items.above)return;d.unwrapNodes(e,{at:t.items.current.path,mode:"all",split:!0,match:Q.equals(e,[t.lists.current.node,t.items.above.node])})}else d.moveNodes(e,{at:r.items.current.path,to:h.next(r.items.above.path)});tt(e,{at:r.lists.above.path})}else d.unwrapNodes(e,{at:r.items.current.path,mode:"all",split:!0,match:function(e){var t;if(!r)return!1;const n=e===r.lists.current.node,o=e===(null==(t=r.items.above)?void 0:t.node);return n||o}})}}const ot={insertExitBreak:function(e){var t;const n={handled:!0},r={handled:!1};if(!e.selection)return n;p.isExpanded(e.selection)&&d.delete(e);const o=Ye.info(e);return o?o.items.current.meta.isSimple?o.blocks.current.meta.isEmpty?(rt(e),n):o.blocks.first?o.blocks.first.meta.isOnStart?((null==(t=o.items.previous)?void 0:t.meta.isEmpty)||d.insertNodes(e,N(),{at:o.items.current.path}),n):o.blocks.first.meta.isOnEnd?(o.blocks.second?d.insertNodes(e,N(),{at:o.blocks.second.path.concat(0),select:!0}):d.insertNodes(e,N(),{at:h.next(o.items.current.path),select:!0}),n):(d.splitNodes(e,{match:Q.equals(e,o.items.current.node),always:!0}),n):n:r:n},deleteBackward:function(e){const t={handled:!1};if(!e.selection)return t;if(p.isExpanded(e.selection))return t;const n=V.getAbove(e,{type:"block",mode:"lowest",match:Q.block(e,"list-item")});if(!n)return t;const[,r]=n,[o]=V.isOnEdges(e,{of:r});return o?(rt(e),{handled:!0}):t},indent:function(e,t={}){const{at:n=e.selection}=t;if(!n)return;if(p.isRange(n)&&p.isExpanded(n))return;const r=Ye.info(e,{at:n});if(!r)return;const{lists:o,items:i}=r;i.current.meta.isFirst||i.previous&&(d.wrapNodes(e,q(o.current.node.type,[]),{at:i.current.path}),d.moveNodes(e,{at:i.current.path,to:i.previous.path.concat(i.previous.node.children.length)}),tt(e,{at:i.previous.path}))},outdent:rt,mergeSiblings:tt,moveChildren:nt};function it({editor:e}){return V.isInBlock(e,["ordered-list","unordered-list"])}Pe.override("delete-backward",(({editor:e,event:t})=>{const{handled:n}=ot.deleteBackward(e);if(!n)return{skipped:!0};t.preventDefault()}),{match:it}),Pe.override("insert-exit-break",(({editor:e,event:t})=>{const{handled:n}=ot.insertExitBreak(e);if(!n)return{skipped:!0};t.preventDefault()}),{match:it}),Pe.override("indent",(({editor:e,event:t})=>{t.preventDefault(),ot.indent(e)}),{match:it}),Pe.override("outdent",(({editor:e,event:t})=>{t.preventDefault(),ot.outdent(e)}),{match:it});const ct={indent:function(e){if(!e.selection)return;if(p.isExpanded(e.selection))return;const t=V.getAbove(e,{type:"block",mode:"lowest",match:Q.block(e,"paragraph")});if(!t)return;const[,n]=t;d.wrapNodes(e,N([]),{at:n});const r=(()=>{const t=f.previous(e,{at:n}),r=f.next(e,{at:n}),o=Q.block(e,["ordered-list","unordered-list"]);if(t){const e=t[0];if(o(e))return e.type}if(r){const e=r[0];if(o(e))return e.type}return"unordered-list"})();d.wrapNodes(e,q(r,[]),{at:n}),ot.mergeSiblings(e)}};Pe.override("indent",(({editor:e,event:t})=>{t.preventDefault(),ct.indent(e)}),{match:function({editor:e}){return V.isInBlock(e,"paragraph")}});const st=M`
...
`,lt=({value:e,onChange:t,readOnly:n=!1,customKeybinds:r={}})=>{const o=ae(),{handleKeyDown:i}=function(e){const t=ae(),n=qe();return g.exports.useEffect((()=>{const t=s(s({},je),e);He.unregisterAll(),Object.entries(t).forEach((([e,t])=>{if(!t)return;const r="string"==typeof t?[t]:t;for(const o of r)He.register(o,((t,r)=>{Pe.execute(e,{editor:t,event:r,ui:n})}))}))}),[e]),{handleKeyDown:g.exports.useCallback((e=>{He.keyDown(e,t)}),[t])}}(r),{handlePaste:c}=$e();return g.exports.useEffect((()=>{e.length>0||t([j()])}),[e]),u.createElement(at,null,u.createElement(st,null),u.createElement(A,{editor:o,value:e,onChange:t},u.createElement(T,{renderElement:F,renderLeaf:ee,onKeyDown:i,readOnly:n,onPaste:c,autoFocus:!0})),!n&&u.createElement(u.Fragment,null,u.createElement(ut,null),u.createElement(Ae,null)))},ut=()=>u.createElement(ye,{renderButtons:()=>u.createElement(u.Fragment,null,u.createElement(Ze,{mark:"bold",icon:"B",action:"make-bold",tooltip:"Bold (⌘B)",style:{fontWeight:"bold"}}),u.createElement(Ze,{mark:"italic",icon:"I",action:"make-italic",tooltip:"Italic (⌘I)",style:{fontStyle:"italic"}}),u.createElement(Ze,{mark:"underlined",icon:"U",action:"make-underlined",tooltip:"Underlined (⌘U)",style:{textDecoration:"underline"}}),u.createElement(Ze,{mark:"inlineCode",icon:u.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",className:"icon icon-tabler icon-tabler-code",width:"24",height:"24",viewBox:"0 0 24 24",strokeWidth:"2",stroke:"currentColor",fill:"none",strokeLinecap:"round",strokeLinejoin:"round"},u.createElement("path",{stroke:"none",d:"M0 0h24v24H0z",fill:"none"}),u.createElement("polyline",{points:"7 8 3 12 7 16"}),u.createElement("polyline",{points:"17 8 21 12 17 16"}),u.createElement("line",{x1:"14",y1:"4",x2:"10",y2:"20"})),action:"make-inline-code",tooltip:"Inline-code (⌘E)",style:{width:18,height:18,paddingLeft:4}}),u.createElement(Ze,{mark:"href",icon:u.createElement("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg"},u.createElement("path",{d:"M14.8284 12L16.2426 13.4142L19.071 10.5858C20.6331 9.02365 20.6331 6.49099 19.071 4.9289C17.509 3.3668 14.9763 3.3668 13.4142 4.9289L10.5858 7.75732L12 9.17154L14.8284 6.34311C15.6095 5.56206 16.8758 5.56206 17.6568 6.34311C18.4379 7.12416 18.4379 8.39049 17.6568 9.17154L14.8284 12Z",fill:"currentColor"}),u.createElement("path",{d:"M12 14.8285L13.4142 16.2427L10.5858 19.0711C9.02372 20.6332 6.49106 20.6332 4.92896 19.0711C3.36686 17.509 3.36686 14.9764 4.92896 13.4143L7.75739 10.5858L9.1716 12L6.34317 14.8285C5.56212 15.6095 5.56212 16.8758 6.34317 17.6569C7.12422 18.4379 8.39055 18.4379 9.1716 17.6569L12 14.8285Z",fill:"currentColor"}),u.createElement("path",{d:"M14.8285 10.5857C15.219 10.1952 15.219 9.56199 14.8285 9.17147C14.4379 8.78094 13.8048 8.78094 13.4142 9.17147L9.1716 13.4141C8.78107 13.8046 8.78107 14.4378 9.1716 14.8283C9.56212 15.2188 10.1953 15.2188 10.5858 14.8283L14.8285 10.5857Z",fill:"currentColor"})),action:"set-link-for-text",tooltip:"Link (⌘K)",style:{width:18,height:18,paddingLeft:4}}))}),dt=({value:e,onChange:t,readOnly:n=!1,customKeybinds:r={},customExtensions:o=[]})=>u.createElement(Ne,{customExtensions:o},u.createElement(lt,{value:e,onChange:t,readOnly:n,customKeybinds:r})),ft=[{type:"heading-1",children:[{text:"Manage map or Set in effector store"}]},{type:"paragraph",children:[{text:"Sometimes we need to save Set in "},{text:"effector",italic:!0,href:"https://effector.dev"},{text:" store.\nSimple "},{text:"createStore(new Set())",inlineCode:!0},{text:" "},{text:"will not",bold:!0},{text:" trigger updates on "},{text:".add(item)",inlineCode:!0}]},{type:"unordered-list",children:[{type:"list-item",children:[{type:"paragraph",children:[{text:"a"}]},{type:"unordered-list",children:[{type:"list-item",children:[{type:"paragraph",children:[{text:"nested"}]}]}]}]},{type:"list-item",children:[{type:"paragraph",children:[{text:"b"}]},{type:"unordered-list",children:[{type:"list-item",children:[{type:"paragraph",children:[{text:"nested"}]}]}]}]},{type:"list-item",children:[{type:"paragraph",children:[{text:"c"}]},{type:"unordered-list",children:[{type:"list-item",children:[{type:"paragraph",children:[{text:"nested"}]}]}]}]}]},{type:"ordered-list",children:[{type:"list-item",children:[{type:"paragraph",children:[{text:"a"}]},{type:"ordered-list",children:[{type:"list-item",children:[{type:"paragraph",children:[{text:"nested"}]}]}]}]},{type:"list-item",children:[{type:"paragraph",children:[{text:"b"}]},{type:"ordered-list",children:[{type:"list-item",children:[{type:"paragraph",children:[{text:"nested"}]}]}]}]}]}];function pt(e,t=0,n=[]){for(const r of e)x.isText(r)||(n.push({name:r.type,offset:t}),pt(r.children,t+2,n));return n}function mt(e){const t=pt(e),n=[];for(const o of t){const e=" ".repeat(o.offset);n.push(e+o.name)}const r=n.join("\n");console.log(r)}const ht=()=>{const[e,t]=function(){const[e,t]=g.exports.useState(ft);return g.exports.useEffect((()=>mt(e)),[e]),[e,t]}();return u.createElement(dt,{value:e,onChange:t})};C.render(u.createElement(ht,null),document.querySelector("#root"));
